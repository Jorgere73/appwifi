...
Funciones: 
	...
	void wificollector_display_all(lista nodos): Esta función imprime todo lo que tengamos contenido en nuestros nodos, para ello utilizamos un for sobre las 21 posiciones posibles, combinado con un while que busca el archivo concreto para cada posición dentro de nuestra cadena de nodos.
